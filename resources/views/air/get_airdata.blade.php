				...
				<div class="hot-page2-alp-con">
					<div class="row" ng-if="loading_data">
						...
						<div class="col-md-9 hot-page2-alp-con-right">
							...
							<div class="hot-page2-alp-con-right-1 row" style="margin-top:20px;">
															...
															<td>
																...
																<div class="col-md-10">
																	<div style="display: inline-flex; font-size: 11px; ">
																		<div style="padding: 0 10px 0 0;     margin-left: 5px;"><img class="img-l"  ng-src="http://tbolite.tektravels.com/Images/Air/AirlineLogo_25x25/@{{flight.AirlineCode}}.gif"/></div>  
												...
												<table id="myTable">
													<tbody  style=" background-color: #fff;">
														...
														<tr ng-repeat="flight in flightsreturns | filter:filterflights">
															...
															<div class="col-md-10">
																<div style="display: inline-flex; font-size: 11px; margin-left: -15px;">
