                        ...
                        <div class="row"  ng-show="options.length > 0" ng-repeat="(index, option) in options track by $index">
                            <div class="form-line tab-content">
                                <div class="row" style=" margin-left: 74px; margin-top: -16px; padding-top: 10px;" >
                                    ...
                                    <div class="input-field col s2 sm12" style="margin-left: -54px; width: 18%;">
                                    ...
                                    <div class="col-sm-2"  ng-if="$last">
                                        <button type="button" style="margin-left: 10px;  margin-top: 17px;     background: #0eafe3;border: none;" ng-click="addmore()" class="btn btn-primary">Add City </button>
                                    </div> 
                                </div>   
                            </div>
                        </div> 
