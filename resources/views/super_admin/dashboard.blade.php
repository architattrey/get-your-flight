                      ...
                      <tbody>
                        <tr>
                          <td class="text-center">
                            <div class="avatar">
                              <img src="{{ asset('node_modules/img/avatars/1.jpg') }}" class="img-avatar" alt="admin@bootstrapmaster.com">
                        ...
                        <tr>
                          <td class="text-center">
                            <div class="avatar">
                              <img src="{{ asset('node_modules/img/avatars/2.jpg') }}" class="img-avatar" alt="admin@bootstrapmaster.com">
                        ...
                        <tr>
                          <td class="text-center">
                            <div class="avatar">
                              <img src="{{ asset('node_modules/img/avatars/3.jpg') }}" class="img-avatar" alt="admin@bootstrapmaster.com">
                        ...
                        <tr>
                          <td class="text-center">
                            <div class="avatar">
                              <img src="{{ asset('node_modules/img/avatars/4.jpg') }}" class="img-avatar" alt="admin@bootstrapmaster.com">
                        ...
                        <tr>
                          <td class="text-center">
                            <div class="avatar">
                              <img src="{{ asset('node_modules/img/avatars/5.jpg') }}" class="img-avatar" alt="admin@bootstrapmaster.com">
                              <span class="avatar-status badge-success"></span>
                            </div>
                          </td>
                          <td>
                        ...
                        <tr>
                          <td class="text-center">
                            <div class="avatar">
                              <img src="{{ asset('node_modules/img/avatars/6.jpg') }}" class="img-avatar" alt="admin@bootstrapmaster.com">
                              <span class="avatar-status badge-danger"></span>
                            </div>
                          </td>
                          <td>
