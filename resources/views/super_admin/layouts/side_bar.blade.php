          ...
          <ul class="nav">
            ...
            <li class="nav-item nav-dropdown">
              <a class="nav-link nav-dropdown-toggle" href="#">
                <i class="nav-icon icon-puzzle"></i> Package</a>
              <ul class="nav-dropdown-items">
                <li class="nav-item">
                  <a class="nav-link" href="{{url('/create/package')}}">
                    <i class="nav-icon icon-puzzle"></i> Create Package</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{url('/package/list')}}">
                    <i class="nav-icon icon-puzzle"></i>Package Lists</a>
                </li>
              </ul>
            </li>
            <li class="nav-item nav-dropdown">
              <a class="nav-link nav-dropdown-toggle" href="#">
                <i class="nav-icon icon-puzzle"></i> Booking</a>
              <ul class="nav-dropdown-items">
                <li class="nav-item">
                  <a class="nav-link" href="{{url('/packages/booking_list')}}">
                    <i class="nav-icon icon-puzzle"></i> Booking Package Lists</a>
                </li>
              </ul>
            </li>
