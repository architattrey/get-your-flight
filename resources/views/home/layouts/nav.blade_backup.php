                    ...
                    <div class="ed-mm-menu">
                        ...
                        <div class="ed-mm-inn">
                            ...
                            <ul>
                                ...
                                <li><a href="places-2.html">Signup and Signin</a></li>
                            </ul>
                            ...
                            <h4>B2B</h4>
                            <ul>
                                <li><a href="places-1.html">Register</a></li>
                                <li><a href="places-2.html">Login</a></li>
                            </ul>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="ed-com-t1-right">
                            <ul>
                                <li><a href="{{route('logins')}}">Sign In</a>
                                </li>
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="dropdown singleDrop active">
                <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">My Account </a>
                  ...
                  <li class=""><a href="#">My Wallet</a></li>
              ...
              <li class="dropdown singleDrop ">
                <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Special Deals</a>
               <ul class="dropdown-menu dropdown-menu-right">
                  <li class=""><a href="#">Hot Deals</a></li>
                   <li class=""><a href="#">Promo code on flights</a></li>
                   <li class=""><a href="#">Promo code on hotel</a></li>
                   <li class=""><a href="#">Hot Deals</a></li>
                   <li class=""><a href="#">Promo code Holiday</a></li>
                </ul>
              </li>
              <li class="dropdown singleDrop">
                <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">B2B </a>
                <ul class="dropdown-menu dropdown-menu-right">
                <li class=""><a href="#" data-toggle="modal" data-target="#signup">Register</a></li>
               ...
               <li class="dropdown singleDrop">
                ...
                <li class=" singleDrop ">
                <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">1800-2432-2324</a>
              </li> -->
        ...
        <div class="top-logo" data-spy="affix" data-offset-top="250">
            <div class="container">
                <div class="row">  
                    <div class="col-md-12">
                        <div class="wed-logo">
                            <a href="http://getflights.aresedge.com"><img src="/images/logo.png" alt="" />
                            </a>
                        </div>
