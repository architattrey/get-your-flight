                      ...
                      <h1>Plan Your Travel Now!</h1>
                        ...
                        <div class="tourz-hom-ser">
                            <ul class="nav nav-tabs">
                                <li class="active">
                                    <a data-toggle="tab" value="1" href="#flights" class="tab_switch waves-effect waves-light btn-large tourz-pop-ser-btn wow fadeInUp" data-wow-duration="0.5s"><img src="images/icon/31.png" alt=""> Flight</a>
                                </li>
                                <li>
                                    <a data-toggle="tab" value="2" href="#hotels" class="tab_switch waves-effect waves-light btn-large tourz-pop-ser-btn wow fadeInUp" data-wow-duration="1s"><img src="images/icon/1.png" alt=""> Hotel</a>
                                </li>
                                <li>
                                    <a data-toggle="tab" value="3" href="#tours" class="tab_switch waves-effect waves-light btn-large tourz-pop-ser-btn wow fadeInUp" data-wow-duration="1.5s"><img src="images/icon/2.png" alt=""> Tour</a>
                                </li>
                                
                                <li>
                                    <a data-toggle="tab" value="4" href="#buses" class="tab_switch waves-effect waves-light btn-large tourz-pop-ser-btn wow fadeInUp" data-wow-duration="2s"><img src="images/icon/30.png" alt=""> Bus</a>
                                </li>
                                <li>
                                    <a data-toggle="tab" value="5" href="#visas" class="tab_switch waves-effect waves-light btn-large tourz-pop-ser-btn wow fadeInUp" data-wow-duration="2s"><img src="images/icon/30.png" alt=""> Visa</a>
                                </li>
                            </ul>
                        </div>
                                ...
                                <div id="flights" class="tab-pane fade in active">
                                    <form class="v2-search-form" name="myForm1" action="/air/getairdata">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="input-field col s2 sm12">
                                                <input type="text" id="to" name="departure_date" class="datepicker" data-provide="datepicker" required>
                                                <label for="to">Departure Date</label>
                                            </div>

                                            <div class="input-field col s2 sm12" ng-if="options.length == 0">
                                                <input type="text" id="from" class="datepicker_re" data-provide="datepicker" name="arrival_date">
                                        ...
                                        <div class="row"  ng-show="options.length > 0" ng-repeat="(index, option) in options track by $index">
                                            <div class="form-line tab-content">
                                                <div class="row" style=" margin-left: 38px;">
                                                    ...
                                                    <div class="input-field col s2 sm12">
                                                        <input type="text" class="virtual_date hasDatepicker" id="from_@{{index + 1}}" name="arrival_date_@{{index + 1}}">
                                        ...
                                        <div class="col-sm-3 col-sm-offset-0 checkbox-inline" style="color: #333;" >
                                        ...
                                        <div class="col-sm-3 col-sm-offset-0 checkbox-inline" style="color: #333;" >
                                            <input type="checkbox" style="margin-top: -10px;  margin-left: -72px;" >
                                            <span style=" margin-left: -53px;">Non Stop Flights</span>
                                        </div>
                                ...
                                <div id="hotels" class="tab-pane fade">
                                    <form class="v2-search-form" action="/gethoteldata" name="myForm2"> 
                                        <div class="row">
                                            ...
                                            <div class="input-field col s2">
                                                <input type="text" id="checkin" name="check_in_date" required>
                                                <label for="from">Check In</label>
                                            </div>
                                            <div class="input-field col s2">
                                                <input type="text" id="checkout" name="check_out_date" required>
    ...
    /* $(document).ready(function() {
        $('body').on('keydown.autocomplete', 'input.virtual_date', function() {
            ...
            // $(this).datepicker('destroy').datepicker({showOn:'focus'}).focus();
             $(this).datepicker({  altFormat: "d MM,DD, yy" });
        })
    });  */


    $(document).on('click', '#delete_flying', function() {
        e.preventDefault()
    })
